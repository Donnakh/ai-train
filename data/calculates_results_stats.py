...
def calculates_results_stats(results_dic):
 ...
 # Creates empty dictionary for results_stats_dic
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1 and results_dic[key][1] in results_dic[key][2]:
        ...
        # Pet Image Label is NOT a Dog
            ...
            if results_dic[key][4] == 0  and results_dic[key][1] in results_dic[key][2]:
    ...
    results_stats_dic['pct_correct_breed'] =results_stats_dic['n_correct_breed'] /  results_stats_dic['n_dogs_img'] 8 100
